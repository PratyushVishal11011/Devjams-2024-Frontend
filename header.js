...
template.innerHTML = `
    ...
    <head>
        ...
        <link rel="stylesheet" href="http://172.18.229.6:5500/header.css">
    ...
    <body>
        <header>
            <div class="logo">
                <img src="http://172.18.229.6:5500/logo.jpg" alt="Website Logo">
            </div>
            <nav>
                <ul>
            ...
            <div class="nav-right">
                <div class="dropdown">
                    <button class="dropbtn">
                        <div class="profile">
                            <img src="http://172.18.229.6:5500/logo.jpg" alt="Profile Image">
                        </div>
